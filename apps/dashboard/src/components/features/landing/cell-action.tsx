...
import type { LandingColumn } from "./columns/type";
...
export const CellAction = ({ data }: Props) => {
    ...
    const onConfirm = async () => {
        try {
            setLoading(true);
            await axios.delete(`/api/${params.storeId}/landings/${data.id}`);
    ...
    const onCopy = (id: string) => {
        ...
        toast.success("Landing ID copied to clipboard.");
    };
            ...
            <DropdownMenu>
                ...
                <DropdownMenuContent align="end">
                    ...
                    <DropdownMenuItem
                        onClick={() =>
                            router.push(
                                `/${params.storeId}/landings/${data.id}`
                            )
                        }
                    >
