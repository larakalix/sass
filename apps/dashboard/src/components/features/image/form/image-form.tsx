...
export const ImageForm = ({ initialData }: Props) => {
    ...
    const title = initialData ? "Edit image" : "Create image";
    const description = initialData ? "Edit a image." : "Add a new image";
    const toastMessage = initialData ? "Image updated." : "Image created.";
